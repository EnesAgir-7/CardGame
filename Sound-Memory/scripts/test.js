...
//Tıklama ve çalıştırma işlevleri
...
$(document).ready(function () {
    ...
    if (cardsOpen.length <= 1) {
        ...
        if (cardsOpen[0] == cardsOpen[1]) {
            ...
            .delay(1000)
            .replaceWith(
            `<div card class="card" id="${cardsOpen2[0]}"><img src="src/team6.png" alt="card" width="100px" height="100px"></div>`
            );
        $("[open2]")
            .delay(1000)
            .replaceWith(
            `<div card class="card" id="${cardsOpen2[1]}"><img src="src/team6.png" alt="card" width="100px" height="100px"></div>`
            );
        cardsOpen = cardsNone;
